...
Continuation inference is selected by `config/continuation.json`:

- `continuation.engine: "single"` loads the configured single checkpoint.
- `continuation.engine: "ensemble"` loads the configured member list with per-member checkpoints, tokenizers, model ids, temperature schedules, and candidate counts.
- Set `HUMMUSE_CONTINUATION_CONFIG` in `.env` or the process environment to point at an alternate JSON config.

| File | SHA-256 |
| --- | --- |
| `best_seed7.pt` | `4fbd2a3c99bfb390907e040e50824f26202b9d5b934565ab0637ccc8ffe02313` |
| `best_seed42.pt` | `8034239722b319c314bd4009cb034e1c034e447efd3b252eb4f7131a6af9465e` |
| `best_seed1337.pt` | `d5ee90bd14e5420e15417e3280b529bfb76f0ea05a6541fd62eb356562c0a17e` |
